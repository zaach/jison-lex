(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@gerhobbelt/xregexp'), require('@gerhobbelt/json5'), require('@gerhobbelt/lex-parser'), require('assert'), require('jison-helpers-lib'), require('@gerhobbelt/recast'), require('@gerhobbelt/ast-util'), require('@gerhobbelt/prettier-miscellaneous')) :
	typeof define === 'function' && define.amd ? define(['@gerhobbelt/xregexp', '@gerhobbelt/json5', '@gerhobbelt/lex-parser', 'assert', 'jison-helpers-lib', '@gerhobbelt/recast', '@gerhobbelt/ast-util', '@gerhobbelt/prettier-miscellaneous'], factory) :
	(global['regexp-lexer'] = factory(global.XRegExp,global.json5,global.lexParser,global.assert,global.helpers,global.recast,global.astUtils,global.prettierMiscellaneous));
}(this, (function (XRegExp,json5,lexParser,assert,helpers,recast,astUtils,prettierMiscellaneous) { 'use strict';
