...
(function (global, factory) {
    (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(require('fs'), require('path'), require('@gerhobbelt/nomnom'), require('@gerhobbelt/xregexp'), require('@gerhobbelt/json5'), require('@gerhobbelt/lex-parser'), require('assert'), require('jison-helpers-lib'), require('@gerhobbelt/recast'), require('@gerhobbelt/ast-util'), require('@gerhobbelt/prettier-miscellaneous')) : typeof define === 'function' && define.amd ? define(['fs', 'path', '@gerhobbelt/nomnom', '@gerhobbelt/xregexp', '@gerhobbelt/json5', '@gerhobbelt/lex-parser', 'assert', 'jison-helpers-lib', '@gerhobbelt/recast', '@gerhobbelt/ast-util', '@gerhobbelt/prettier-miscellaneous'], factory) : factory(global.fs, global.path, global.nomnom, global.XRegExp, global.json5, global.lexParser, global.assert, global.helpers, global.recast, global.astUtils, global.prettierMiscellaneous);
})(undefined, function (fs, path, nomnom, XRegExp, json5, lexParser, assert, helpers, recast, astUtils, prettierMiscellaneous) {
    'use strict';
    ...
    */
    ...
    function generateModuleBody(opt) {
        ...
        if (opt.rules.length > 0 || opt.__in_rules_failure_analysis_mode__) {
            var code = [rmCommonWS(_templateObject3), '/*JISON-LEX-ANALYTICS-REPORT*/' /* slot #1: placeholder for analysis report further below */
            ];
            ...
            code.push(rmCommonWS(_templateObject4, performActionCode, simpleCaseActionClustersCode, rulesCode, conditionsCode));
    ...
    function generateGenericHeaderComment() {
        var out = rmCommonWS(_templateObject5, version$1);
    ...
    function generateESModule(opt) {
        ...
        var out = [generateGenericHeaderComment(), '', 'var lexer = (function () {', jisonLexerErrorDefinition, '', generateModuleBody(opt), '', opt.moduleInclude ? opt.moduleInclude + ';' : '', '', 'return lexer;', '})();', '', 'function yylex() {', '    return lexer.lex.apply(lexer, arguments);', '}', rmCommonWS(_templateObject6)];
