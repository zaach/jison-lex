...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('fs'), require('path'), require('@gerhobbelt/nomnom'), require('@gerhobbelt/xregexp'), require('@gerhobbelt/json5'), require('@gerhobbelt/lex-parser'), require('assert'), require('jison-helpers-lib'), require('@gerhobbelt/recast'), require('@gerhobbelt/ast-util'), require('@gerhobbelt/prettier-miscellaneous')) :
	typeof define === 'function' && define.amd ? define(['fs', 'path', '@gerhobbelt/nomnom', '@gerhobbelt/xregexp', '@gerhobbelt/json5', '@gerhobbelt/lex-parser', 'assert', 'jison-helpers-lib', '@gerhobbelt/recast', '@gerhobbelt/ast-util', '@gerhobbelt/prettier-miscellaneous'], factory) :
	(factory(global.fs,global.path,global.nomnom,global.XRegExp,global.json5,global.lexParser,global.assert,global.helpers,global.recast,global.astUtils,global.prettierMiscellaneous));
}(this, (function (fs,path,nomnom,XRegExp,json5,lexParser,assert,helpers,recast,astUtils,prettierMiscellaneous) { 'use strict';
